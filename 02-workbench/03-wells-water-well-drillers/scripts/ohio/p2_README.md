...
python 02-workbench/03-wells-water-well-drillers/scripts/ohio/scrape_ohio.py

# 2. Extract layout text to a diagnostic sample file (for verification)
python 02-workbench/03-wells-water-well-drillers/scripts/ohio/inspect_ohio_pdf.py

# 3. Parse PDF and initialize the SQLite database
python 02-workbench/03-wells-water-well-drillers/scripts/ohio/parse_ohio_pdf.py

# 4. Enrich database listings using the general Places API enricher
python 02-workbench/03-wells-water-well-drillers/scripts/general/enrich_places_general.py --state ohio --limit 100
```
