...
python 02-workbench/03-wells-water-well-drillers/scripts/texas/scratch_test_texas_api.py

# Ingest the entire Texas dataset and build the SQLite database
python 02-workbench/03-wells-water-well-drillers/scripts/texas/bootstrap_texas_wells.py
```
