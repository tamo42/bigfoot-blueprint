...
def run_loop():
    ...
    while True:
        ...
        res3 = subprocess.run(["python", "02-workbench/03-wells-water-well-drillers/scripts/general/p3_enrich_listings.py", "--mode", "full", "--state", "all", "--limit", "100"], cwd=WORKSPACE)
