...
def get_workspace_root():
    ...
    Since this file is located at 02-workbench/03-wells-water-well-drillers/scripts/general/utils.py,
    the root is 5 parent directories up.
    """
    current_file = os.path.abspath(__file__)
    # 02-workbench/03-wells-water-well-drillers/scripts/general/utils.py -> general
    d1 = os.path.dirname(current_file)
    # general -> scripts
    d2 = os.path.dirname(d1)
    # scripts -> 03-wells-water-well-drillers
    d3 = os.path.dirname(d2)
    # 03-wells-water-well-drillers -> 02-workbench
...
def get_db_path(state):
    ...
    return resolve_path(f"02-workbench/03-wells-water-well-drillers/data/{db_name}")

def get_unified_db_path():
    """
    Returns the absolute path to the unified consolidated SQLite database.
    """
    return resolve_path("02-workbench/03-wells-water-well-drillers/data/water_well_directory.sqlite")
