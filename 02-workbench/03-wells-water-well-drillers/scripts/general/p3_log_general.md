...
1.  **[utils.py](file:///c:/Users/tamo4/git/nhq-bigfoot-blueprint/02-workbench/03-wells-water-well-drillers/scripts/general/utils.py)**
    ...
    *   **Functions:**
        ...
        *   `get_db_path(state)`: Resolves `02-workbench/03-wells-water-well-drillers/data/{state}_wells.sqlite`.

2.  **[schema.py](file:///c:/Users/tamo4/git/nhq-bigfoot-blueprint/02-workbench/03-wells-water-well-drillers/scripts/general/schema.py)**
...
3.  **[enrich_places_general.py](file:///c:/Users/tamo4/git/nhq-bigfoot-blueprint/02-workbench/03-wells-water-well-drillers/scripts/general/enrich_places_general.py)**
    ...
    *   **Execution:**
        ...
        python 02-workbench/03-wells-water-well-drillers/scripts/general/enrich_places_general.py --state ohio

        # Enrich Georgia database with specific safety limit
        python 02-workbench/03-wells-water-well-drillers/scripts/general/enrich_places_general.py --state georgia --limit 50

        # Specify database path directly
        python 02-workbench/03-wells-water-well-drillers/scripts/general/enrich_places_general.py --state Texas --db 02-workbench/03-wells-water-well-drillers/data/texas_wells.sqlite --limit 150
        ```
