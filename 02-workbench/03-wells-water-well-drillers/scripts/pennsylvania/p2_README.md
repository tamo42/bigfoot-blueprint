...
2. Run `scrape_pennsylvania.py` to fetch, sanitize, and insert the raw registry into `02-workbench/03-wells-water-well-drillers/data/pennsylvania_wells.sqlite`.
