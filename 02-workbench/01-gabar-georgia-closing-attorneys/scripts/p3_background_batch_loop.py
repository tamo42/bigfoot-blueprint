...
def run_loop():
    ...
    while True:
        ...
        scripts_dir = r"02-workbench\01-gabar-georgia-closing-attorneys\scripts"
        ...
        try:
            ...
            subprocess.run(["git", "add", r"02-workbench\01-gabar-georgia-closing-attorneys\data\directory.sqlite"], cwd=WORKSPACE, check=False)
