...
* **Routing Constraints:** 
  * Flat structure for hubs: `domain.com/atlanta-mobile-notaries`
...
2. **Execute Phase 1:** Navigate to `02-workbench/answerthepublic/scripts/` and run `fetch-atp.py` for "mobile notary" and "loan signing agent". Save the output and draft the `p1_intent_manifest.md` inside a new `02-workbench/mobile-notaries/` folder.
