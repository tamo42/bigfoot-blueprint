...
def main():
    ...
    subprocess.run([sys.executable, "02-workbench/water-well-drillers/scripts/general/p3_enrich_places_apify.py", "--state", "all", "--limit", "100"], cwd=WORKSPACE)
    ...
    subprocess.run([sys.executable, "02-workbench/water-well-drillers/scripts/general/p3_enrich_listings.py", "--mode", "full", "--state", "all", "--limit", "100"], cwd=WORKSPACE)
